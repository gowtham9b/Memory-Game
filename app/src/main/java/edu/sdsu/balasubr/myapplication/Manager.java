...
public class Manager extends Activity {
    ...
    private View createImageButton(int x, int y){
        ...
        button.setBackground(ResourcesCompat.getDrawable(getResources(), R.drawable.icon, null));
    ...
    class UpdateCardsHandler extends Handler{
        ...
        public void checkCards(){
            if(cards[secondCard.x][secondCard.y] == cards[firstCard.x][firstCard.y]){
                ...
                secondCard.button.setBackground(ResourcesCompat.getDrawable(getResources(), R.drawable.icon, null));
                firstCard.button.setBackground(ResourcesCompat.getDrawable(getResources(), R.drawable.icon, null));
            }
